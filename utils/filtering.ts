import { AgentRunResponse, AgentRunStatus, AgentRunFilters, SortOptions } from "../types";

export function filterAgentRuns(runs: AgentRunResponse[], filters: AgentRunFilters): AgentRunResponse[] {
...
export function sortAgentRuns(runs: AgentRunResponse[], sortOptions: SortOptions): AgentRunResponse[] {
...
export function getStatusFilterOptions(runs: AgentRunResponse[]): Array<{ status: AgentRunStatus; count: number; label: string }> {
